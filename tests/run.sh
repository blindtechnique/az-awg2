...
run "AWG2: цели, живой профиль, сохранность ключей и поставка verifier" \
    "$PY" tests/test_awg2_profile.py
...
head_ "Адрес сервера"
run "сверка хоста у клиентов и угаданный приватный адрес" \
