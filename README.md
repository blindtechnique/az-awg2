...
**Проверка обновлений** (🔎) сравнивает код установщика AntiZapret и код слоя на GitHub с установленными версиями и сообщает, есть ли смысл обновляться. Списки блокировок в проверку не входят — они меняются постоянно и обновляются отдельной кнопкой.
