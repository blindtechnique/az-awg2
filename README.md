...
Предупреждения `shellcheck` пока не блокируют сборку — их объём на
унаследованном коде не измерен, и красный CI с первого дня чинить никто не
станет; шаг оставлен справочным, чтобы объём был виден.
